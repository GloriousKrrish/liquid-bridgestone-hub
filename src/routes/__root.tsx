...
function BridyFAB() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-[200] w-14 h-14 rounded-full flex items-center justify-center border border-white/20 shadow-2xl transition-all hover:scale-110 cursor-pointer bg-gradient-to-tr from-[#D71920] via-[#D71920] to-[#FF007A] p-[2px] group"
    >
